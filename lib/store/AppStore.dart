...
abstract class AppStoreBase with Store {
  ...
  Future<void> setDarkMode(bool aIsDarkMode) async {
    ...
    if (isDarkModeOn) {
      appPrimaryColor = primaryDarkColor;
      textPrimaryColorGlobal = textPrimaryWhiteColor;
      ...
      textSecondaryColorGlobal = textSecondaryBlackColor;
  ...
  Future<void> setLanguage(String aSelectedLanguageCode, {BuildContext? context}) async {
    selectedLanguage = aSelectedLanguageCode;
