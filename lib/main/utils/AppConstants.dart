...
const appName = 'KiviCare';
const appFirstName = 'Kivi';
...
String mBaseUrl = 'https://wordpress.iqonic.design/product/wp/kivicare/wp-json/';

const packageName = "com.iqonic.kivicare"; // Do not change this Package Name.
...
const termsAndConditionURL = 'https://iqonic.design/tc/';
const privacyPolicyURL = 'https://www.google.com';
const supportURL = 'https://iqonic.desky.support/';
const codeCanyonURL = "https://codecanyon.net/item/kivicare-flutter-app-clinic-patient-management-system/30970616";
const appShareURL = "https://codecanyon.net/item/kivicare-flutter-app-clinic-patient-management-system/30970616";
const mailto = "hello@iqonic.design";
...
const TOTAL_APPOINTMENT = "Total Appointments";
