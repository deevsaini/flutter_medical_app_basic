...
class WeeklyChartComponentState extends State<WeeklyChartComponent> {
    ...
    return BarChartData(
      ...
      barTouchData: BarTouchData(
        touchTooltipData: BarTouchTooltipData(
            tooltipBgColor: scaffoldBgColor,
  ...
  Widget getTitles(double value, TitleMeta meta) {
    ...
    switch (value.toInt()) {
      case 0:
        return text = Text('\n${languageTranslate("lblMon")}', style: secondaryTextStyle(size: 12, color: secondaryTxtColor));
      case 1:
        return text = Text('\n${languageTranslate("lblTue")}', style: secondaryTextStyle(size: 12, color: secondaryTxtColor));
      case 2:
        return text = Text('\n${languageTranslate("lblWed")}', style: secondaryTextStyle(size: 12, color: secondaryTxtColor));
      case 3:
        return text = Text('\n${languageTranslate("lblThu")}', style: secondaryTextStyle(size: 12, color: secondaryTxtColor));
      case 4:
        return text = Text('\n${languageTranslate("lblFri")}', style: secondaryTextStyle(size: 12, color: secondaryTxtColor));
      case 5:
        return text = Text('\n${languageTranslate("lblSat")}', style: secondaryTextStyle(size: 12, color: secondaryTxtColor));
      case 6:
        return text = Text('\n${languageTranslate("lblSun")}', style: secondaryTextStyle(size: 12, color: secondaryTxtColor));
      default:
